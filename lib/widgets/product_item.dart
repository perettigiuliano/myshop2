  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      borderRadius: BorderRadius.circular(10),
        ...
        header: GridTileBar(title: Text(product.title, textAlign: TextAlign.center, style: TextStyle(color: Colors.yellow, fontSize: 16.0, fontWeight: FontWeight.bold)), 
        ...
        footer: GridTileBar(title: Text("€ " + product.price.toString(), textAlign: TextAlign.center), backgroundColor: Color.fromARGB(180, 0, 0, 0),
          leading: IconButton(icon: Icon(Icons.favorite_border), onPressed: () {  }, color: Colors.grey /* Theme.of(context).accentColor */,),
